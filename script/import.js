...
const subject = document.querySelector('.js-import')
...
// a function that set the values of these object
// a function that checks that the required inputs are valid
// a function that checks whether the submitted address actually exist and that the patient can confirm it
// a function that finally submits the submitted data
